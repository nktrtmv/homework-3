...
extension UIColor: Comparable {
    var rgba: (redComponent: CGFloat, greenComponent: CGFloat, blueComponent: CGFloat, alphaComponent: CGFloat) {
    ...
    public static func <(lhs: UIColor, rhs: UIColor) -> Bool {
        lhs.rgba.redComponent < rhs.rgba.redComponent && lhs.rgba.greenComponent < rhs.rgba.greenComponent
                && lhs.rgba.blueComponent < rhs.rgba.blueComponent
    }
}
