...
final class NewsListViewController: UIViewController {
    ...
    @objc
    private func goBack() {
        let x = navigationController?.popViewController(animated: true)
        if (x == nil) {
    ...
    private func fetchNews() {
        if let url = URL(string: "https://newsapi.org/v2/top-headlines?country=us&apiKey=e9b9366162ac46488b5a2164673a9fec") {
